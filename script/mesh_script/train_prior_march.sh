...
cmt="march_prior"
ckpt="/data/intern1_siqichen/lion_exp/0426/march/march_vae/checkpoints/epoch_4999_iters_34999.pt"
...
$ENT \
    --config "./config/march_prior_cfg.yml" \
    --exp_root $OUTPUT_DIR \
    ...
    cmt $cmt \
    data.cates march data.dataset_type mesh data.data_dir ./data/MESH \
    data.nclass 1 \
    data.tr_max_sample_points 2048 data.te_max_sample_points 2048 \
    log_dir $OUTPUT_DIR/march/march_prior \
    save_dir $OUTPUT_DIR/march/march_prior